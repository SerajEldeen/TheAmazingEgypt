...
import PlacesInfo from "../../constants/CairoPlacesInfo";

export default function CairoPlaces() {
        ...
        <InView key={sectionIndex} triggerOnce threshold={0.2}>
          {({ inView, ref }) => (
            <div
              ...
              className={`flex lg:flex-row flex-col-reverse items-center justify-evenly px-6 sm:px-8 gap-10 cursor-grab sm:cursor-auto mb-7 
            ...
            >
              <div>
                ...
                <ul className="list-disc marker:text-primary">
                  {e.points.map((point, i) => (
                    <li
                      key={i}
                      className=" text-sm sm:text-lg font-semibold text-secondary"
                    >
                      {point}
                    </li>
                  ))}
              ...
              <div className="w-[250px] h-[300px] sm:w-[550px] sm:h-[400px] relative rounded">
                <Slider
                ...
                >
                  {e.images.map((myImg, i) => (
                    <img
                      ...
                      src={myImg.src}
                      alt={myImg.no}
                      className="sm:h-[400px] h-[300px] object-cover"
                    />
                  ))}
                </Slider>
